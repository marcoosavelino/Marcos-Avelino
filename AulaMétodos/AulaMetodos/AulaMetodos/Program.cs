...
namespace Aula_Métodos
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int pQuantNumeros, numero = SomaNumerosInteirosBasico(3, 5, 10); // atribuição e declaração de variáveis
            ...
            pQuantNumeros = Convert.ToInt32(Console.ReadLine());
            numero = SomaNumerosInteiros(pQuantNumeros);

            Console.WriteLine(SomaNumerosInteiros(pQuantNumeros));
